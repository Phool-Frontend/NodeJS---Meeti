...
exports.crearNuevaCuenta = async (req,res) =>{
    ...
    try {
        ...
        const errExp = erroresExpress.map(err => err.message);
...
exports.confirmarCuenta = async (req,res,next) =>{
    ...
    //sino existe,redireccionar y redireccionar
    if(!usuario){
    ...
    req.flash('exito','La cuenta se ha confirmardo,ya puedes iniciar sesion');
    res.redirect('/iniciar-sesion');
}
...
// Muestra el formulario para sunbir una imagen de perfil
